programa
{
	...
	funcao inicio() {
		...
		inteiro op, contP=0, opC, l
		real m2[li][co], precoU, precoP, precoT, quantP, quantT
		logico existe
		...
		escolha(op){
				...
				escolha(op){
					...
					escreva(contP)
						se(contP>=li){
							...
							inteiro posicao = buscar(nome, m1, contP)
			...
			caso 2:
				...
				escolha(op){
					...
					//venda = listar produtos vendidos
					caso 2:
					pare
 ...
 * @POSICAO-CURSOR = 428; 
 * @PONTOS-DE-PARADA = ;
 * @SIMBOLOS-INSPECIONADOS = {m1, 31, 9, 2}-{m2, 33, 7, 2};
